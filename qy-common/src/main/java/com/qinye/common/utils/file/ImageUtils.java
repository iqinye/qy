 ...
 */
package com.qinye.common.utils.file;

import com.qinye.common.config.QyConfig;
import com.qinye.common.constant.Constants;
import com.qinye.common.utils.StringUtils;
import com.qinye.common.utils.sign.Base64Utils;
 ...
 * @Title ImageUtils
 * @Package com.qinye.common.utils.file
 * @Description: (图片文件类处理工具类)
 * @Author qinye
 * @Date 2022年08月13天 18时50分
...
public class ImageUtils {
    ...
    public static byte[] readFile(String url) {
        ...
        try {
            if (url.startsWith("http")) {
                ...
                // 本机地址
                String localPath = QyConfig.getProfile();
    ...
    public static InputStream compressImg(String base64, float quality) {
        try {
            byte[] images = Base64Utils.decode(base64);
